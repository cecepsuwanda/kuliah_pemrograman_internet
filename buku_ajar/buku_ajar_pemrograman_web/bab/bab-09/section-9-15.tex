...
\begin{tikzpicture}[
  every node/.style={font=\scriptsize, draw, rounded corners, minimum width=1.75cm, minimum height=0.65cm},
  level 1/.style={sibling distance=4.2cm, level distance=1.45cm},
  level 2/.style={sibling distance=2.15cm, level distance=1.45cm},
  level 3/.style={sibling distance=1.65cm, level distance=1.45cm}
]
