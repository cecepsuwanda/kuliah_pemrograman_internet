...
\begin{tabular}{|P{2.1cm}|P{4.95cm}|P{5.35cm}|}
\hline
...
\hline
Contoh & \parbox[t]{4.95cm}{\raggedright\ttfamily\scriptsize filter\_var(FILTER\_VALIDATE\_EMAIL)} & \code{htmlspecialchars()}, \code{trim()} \\
\hline
