...
<head>
    ...
    <meta property="og:description" content="Contoh CV Bab 12: data dari JSON, dirender server-side dengan PHP dan AdminLTE.">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
            ...
            <span class="navbar-brand m-0 d-none d-sm-inline font-weight-light">Curriculum Vitae — Bab 12 (PHP + AdminLTE)</span>
        </nav>
        ...
        <footer class="main-footer text-sm">
            <div class="container-fluid text-center">
                <p class="mb-0 text-muted">
                    ...
                    <?= h($cv['footer']['text']) ?>
                    <code>data/cv-data.json</code> + <code>index.php</code> (PHP).
                </p>
            </div>
        </footer>
    </div>
