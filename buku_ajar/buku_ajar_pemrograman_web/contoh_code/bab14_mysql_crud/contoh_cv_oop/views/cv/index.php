...
<head>
    ...
    <meta property="og:description" content="Contoh CV Bab 14: arsitektur MVC OOP PHP, data MySQL, AdminLTE.">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
            ...
            <span class="navbar-brand m-0 d-none d-sm-inline font-weight-light">Curriculum Vitae — Bab 14 (PHP OOP + MySQL MVC)</span>
        </nav>
        ...
        <footer class="main-footer text-sm">
            <div class="container-fluid text-center">
                <p class="mb-0 text-muted">
                    ...
                    <?= h($cv['footer']['text']) ?>
                    <code>MySQL (cv_portfolio)</code> + MVC PHP (<code>CvModel</code>, <?= h($driverLabel) ?>).
                </p>
            </div>
        </footer>
    </div>
