            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right text-nowrap">
                        <a class="btn btn-sm btn-info" href="<?= admin_url('keterampilan.php') ?>?id=<?= (int) $item['id'] ?>">Edit</a>
                        <form method="post" action="<?= admin_url('keterampilan.php') ?>" class="d-inline" onsubmit="return confirm('Hapus item ini?');">
...
<form method="post" action="<?= admin_url('keterampilan.php') ?>" class="card card-secondary card-outline">
    ...
    <div class="card-footer">
        ...
        <?php if ($editItem): ?>
        <a href="<?= admin_url('keterampilan.php') ?>" class="btn btn-secondary">Batal</a>
        <?php endif; ?>
    </div>
</form>
<?php
