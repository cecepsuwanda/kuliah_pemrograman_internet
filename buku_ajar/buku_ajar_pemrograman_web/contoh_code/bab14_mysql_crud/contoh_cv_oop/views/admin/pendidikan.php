            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right text-nowrap">
                        <a class="btn btn-sm btn-info" href="<?= admin_url('pendidikan.php') ?>?id=<?= (int) $row['id'] ?>">Edit</a>
                        <form method="post" action="<?= admin_url('pendidikan.php') ?>" class="d-inline" onsubmit="return confirm('Hapus baris ini?');">
...
<form method="post" action="<?= admin_url('pendidikan.php') ?>" class="card card-secondary card-outline">
    ...
    <div class="card-footer">
        ...
        <?php if ($editRow): ?>
        <a href="<?= admin_url('pendidikan.php') ?>" class="btn btn-secondary">Batal</a>
        <?php endif; ?>
    </div>
</form>
<?php
