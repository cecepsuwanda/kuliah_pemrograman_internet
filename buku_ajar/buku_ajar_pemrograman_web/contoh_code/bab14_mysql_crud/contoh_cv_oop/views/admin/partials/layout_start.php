...
<head>
    ...
    <title><?= h($title) ?> — Admin CV (Bab 14 MySQL MVC)</title>
...
<div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= admin_url('logout.php') ?>"><i class="fas fa-sign-out-alt mr-1"></i> Logout</a>
            </li>
        </ul>
    </nav>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="<?= admin_url('index.php') ?>" class="brand-link">
            <span class="brand-text font-weight-light">Admin CV (Bab 14 MySQL)</span>
        </a>
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column">
                    ...
                    ?>
                    <li class="nav-item">
                        <a href="<?= admin_url($href) ?>" class="nav-link <?= $active === $key ? 'active' : '' ?>">
