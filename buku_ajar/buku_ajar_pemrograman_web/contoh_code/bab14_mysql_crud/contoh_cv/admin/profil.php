...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $fields = [
            'documentTitle' => postString('documentTitle'),
            'metaDescription' => postString('metaDescription'),
            'name' => postString('name'),
            'role' => postString('role'),
            'location' => postString('location'),
            'email' => postString('email'),
            'phoneE164' => postString('phoneE164'),
            'phoneDisplay' => postString('phoneDisplay'),
            'website' => postString('website'),
            'address' => postString('address'),
            'footer_year' => postString('footer_year', (string) date('Y')),
            'footer_text' => postString('footer_text'),
        ];
