    ...
    try {
        if ($action === 'delete') {
            ...
            if ($heading === '' || $judul === '' || $linkHref === '' || $linkText === '') {
                ...
                setFlash('success', $id !== null ? 'Portofolio diperbarui.' : 'Portofolio ditambahkan.');
                redirect('portofolio.php');
            }
        }
...
if ($editId !== null) {
    $editItem = findCvItemById($cv['portofolio']['items'], $editId);
}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right text-nowrap">
                        <a class="btn btn-sm btn-info" href="portofolio.php?id=<?= (int) $item['id'] ?>">Edit</a>
