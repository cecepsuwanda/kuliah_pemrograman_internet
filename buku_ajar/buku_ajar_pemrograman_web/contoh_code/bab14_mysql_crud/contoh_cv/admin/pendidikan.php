    ...
    try {
        if ($action === 'delete') {
            ...
            $fields = [
                ...
                'selesai_label' => postString('selesai_label'),
            ];
            ...
            if ($heading === '' || $fields['jenjang'] === '' || $fields['institusi'] === '' || $fields['program'] === '' || $fields['mulai_label'] === '') {
                ...
                setFlash('success', $id !== null ? 'Pendidikan diperbarui.' : 'Pendidikan ditambahkan.');
                redirect('pendidikan.php');
            }
        }
...
$selesaiLabelVal = '';
if ($editRow) {
    [$mulaiDatetimeVal, $mulaiLabelVal, $selesaiLabelVal] = parseEducationPeriode($editRow);
}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right text-nowrap">
                        <a class="btn btn-sm btn-info" href="pendidikan.php?id=<?= (int) $row['id'] ?>">Edit</a>
