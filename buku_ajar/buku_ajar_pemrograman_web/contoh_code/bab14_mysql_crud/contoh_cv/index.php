...
<head>
    ...
    <meta name="keywords" content="CV, Curriculum Vitae, PHP, MySQL, AdminLTE, Mahasiswa">
    <meta name="author" content="<?= h($person['name']) ?>">
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?= h($cv['documentTitle']) ?>">
    <meta property="og:description" content="Contoh CV Bab 14: data dari MySQL, dirender server-side dengan PHP dan AdminLTE.">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
            ...
            <span class="navbar-brand m-0 d-none d-sm-inline font-weight-light">Curriculum Vitae — Bab 14 (PHP + MySQL + AdminLTE)</span>
        </nav>
                                    ...
                                    <table class="table table-hover table-striped table-bordered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= h($row['program']) ?></td>
                                                <td><?= renderPeriodeSegments($row['periodeSegments']) ?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
                        ...
                        <section id="organisasi" class="card card-primary card-outline mb-3" aria-labelledby="judul-organisasi">
                            ...
                            <div class="card-body">
                                <ul id="cv-organisasi-list" class="mb-0">
                                    ...
                                    <li>
                                        <?= h($item['teks']) ?>
                                        <?= renderPeriodeSegments($item['periodeSegments']) ?>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
        ...
        <footer class="main-footer text-sm">
            <div class="container-fluid text-center">
                <p class="mb-0 text-muted">
                    ...
                    <?= h($cv['footer']['text']) ?>
                    <code>MySQL (cv_portfolio)</code> + <code><?= h($driverLabel) ?></code>.
                </p>
            </div>
        </footer>
    </div>
