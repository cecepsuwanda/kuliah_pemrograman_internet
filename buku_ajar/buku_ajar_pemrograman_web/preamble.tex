...
\usepackage{lmodern}
\usepackage{microtype} % Memperbaiki banyak masalah overfull/underfull box secara otomatis
...
% Abaikan argumen opsi dari pengguna dan paksa menggunakan [H]
\renewenvironment{table}[1][H]
  {\oldtable[H]\centering\small\setlength{\tabcolsep}{4pt}}
  {\endoldtable}
...
\setlength{\floatsep}{1.5em plus 0.2em minus 0.2em}
\setlength{\textfloatsep}{1.5em plus 0.2em minus 0.2em}
\setlength{\intextsep}{1.5em plus 0.2em minus 0.2em}
\setlength{\LTpre}{1.5em plus 0.2em minus 0.2em}  % Jarak sebelum longtable
\setlength{\LTpost}{1.5em plus 0.2em minus 0.2em} % Jarak sesudah longtable

% Mengurangi Underfull \vbox (badness) pada halaman dengan sedikit konten
\raggedbottom
% Mengurangi Overfull/Underfull \hbox (bad box)
\sloppy
% Abaikan overfull/underfull untuk teks panjang yang tidak bisa direnggangkan (inline code)
\hfuzz=50pt
\vfuzz=50pt
% Menghilangkan pesan warning bad box sepenuhnya pada proses kompilasi
\hbadness=10000
\vbadness=10000
