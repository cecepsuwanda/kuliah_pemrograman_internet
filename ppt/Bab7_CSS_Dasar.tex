...
% Outline dan CPMK
\begin{frame}[shrink=15]{Outline Bab 7}
...
\begin{frame}{Display: block, inline, inline-block}
	...
	\vspace{0.5em}
	\raggedright
	\texttt{display: none}: elemen tidak mengambil ruang.\\
	\texttt{visibility: hidden}: elemen tetap mengambil ruang.
\end{frame}
...
\begin{frame}{Satuan dan Nilai}
	...
	\vspace{0.35em}
	\begin{itemize}
		\item \texttt{calc(100\% - 2rem)} untuk hitungan panjang--lebar
		\item Nilai khusus: \texttt{auto}, \texttt{inherit}, \texttt{initial}
	\end{itemize}
\end{frame}
