...
XSS (Cross-Site Scripting) terjadi ketika input pengguna dieksekusi sebagai script di browser korban \cite{owasp-xss}. Pencegahan: escape output (encode HTML entities), gunakan header \texttt{Content-Security-Policy}, validasi input \cite{owasp-xss}.
