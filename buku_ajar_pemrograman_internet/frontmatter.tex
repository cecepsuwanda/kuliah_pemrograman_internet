...
Server-side, basis data, PHP, MySQL, keamanan web, dan integrasi proyek.
...
\begin{itemize}
  ...
  \item Manfaatkan GitHub Copilot sebagai asisten coding sesuai etika akademik \cite{copilot}
...
\begin{enumerate}
  \item \textbf{CPL-1 (Pengetahuan):} Menguasai konsep teoretis arsitektur web, protokol HTTP, serta pemrograman client-side dan server-side (PHP, MySQL) secara mendalam.
  ...
  \item \textbf{CPL-3 (Keterampilan Khusus):} Mampu merancang, mengimplementasikan, dan mengevaluasi aplikasi web dengan teknologi HTML, CSS, JavaScript, PHP, MySQL serta prinsip keamanan dasar.
...
\begin{enumerate}
  ...
  \item \textbf{CPMK-4:} Mahasiswa mampu menerapkan prinsip keamanan web (validasi input, prepared statement, session) pada aplikasi berbasis web.
\end{enumerate}
...
\begin{tabular}{|c|c|c|p{4.5cm}|}
  ...
  \hline
  CPL-3 & CPMK-4 & Tinggi & Implementasi keamanan web dan integrasi aplikasi \\
  \hline
