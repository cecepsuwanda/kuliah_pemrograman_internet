  ...
  <div class="canvas-container">
    ...
    <div class="canvas-controls">
      <div class="control-group">
        ...
        <div>
          <button class="btn active" onclick="setTool('pen')">[Pen] Pen</button>
          <button class="btn" onclick="setTool('eraser')">[Eraser] Eraser</button>
          <button class="btn" onclick="setTool('line')">[Line] Line</button>
          <button class="btn" onclick="setTool('rectangle')">[Rect] Rectangle</button>
          <button class="btn" onclick="setTool('circle')">[Circle] Circle</button>
          <button class="btn" onclick="setTool('text')">[Text] Text</button>
        </div>
      </div>
...
<body>
  ...
  <div class="media-container">
    <div class="media-section">
      <h2>[Video] Responsive Video Gallery</h2>
