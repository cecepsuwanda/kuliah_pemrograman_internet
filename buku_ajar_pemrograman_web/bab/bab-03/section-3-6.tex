...
<body>
  ...
  <ul>
    <li>[OK] Semua images memiliki alt text yang deskriptif</li>
    <li>[OK] Menggunakan loading="lazy" untuk performance</li>
    <li>[OK] Responsive dengan max-width: 100%</li>
    <li>[OK] Optimized untuk web (compressed)</li>
    <li>[OK] Semantic dengan figure dan figcaption</li>
  </ul>
</body>
</html>
\end{lstlisting}
