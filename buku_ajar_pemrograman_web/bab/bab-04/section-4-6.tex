...
HTML5 menyediakan APIs untuk mengakses fitur device dan informasi lokasi pengguna. Geolocation API memungkinkan aplikasi web untuk mendapatkan lokasi fisik user, sementara Device APIs memberikan akses ke hardware seperti kamera, microphone, dan sensors \cite{mdn-api}. APIs ini membuka kemungkinan untuk aplikasi web yang lebih interaktif dan personal \cite{w3schools-html}.
...
<body>
  ...
  <div class="geo-demo">
    ...
    <div>
      <button class="btn" onclick="getCurrentLocation()">[Loc] Dapatkan Lokasi</button>
      <button class="btn" onclick="startWatching()">[Play] Mulai Tracking</button>
      <button class="btn" onclick="stopWatching()">[Stop] Stop Tracking</button>
      <button class="btn" onclick="clearLocation()">[X] Clear</button>
    </div>
  ...
  <div class="geo-demo">
    <h2>[Map] Reverse Geocoding (Simulasi)</h2>
    
    <button class="btn" onclick="getAddress()">[Home] Dapatkan Alamat</button>
  ...
  <script>
    ...
    function showPosition(position) {
      ...
      document.getElementById('heading').textContent = coords.heading ? coords.heading.toFixed(0) + ' deg' : 'Not available';
...
<body>
  ...
  <div class="sensor-demo">
    <h2>[Compass] Device Orientation</h2>
    
    <div>
      <button class="btn" onclick="startOrientation()">[Play] Start Orientation</button>
      <button class="btn" onclick="stopOrientation()">[Stop] Stop Orientation</button>
    </div>
  ...
  <div class="sensor-demo">
    <h2>[Motion] Device Motion (Accelerometer)</h2>
    
    <div>
      <button class="btn" onclick="startMotion()">[Play] Start Motion</button>
      <button class="btn" onclick="stopMotion()">[Stop] Stop Motion</button>
    </div>
  ...
  <script>
    ...
    function handleOrientation(event) {
      ...
      document.getElementById('alpha').textContent = alpha.toFixed(1) + ' deg';
      document.getElementById('beta').textContent = beta.toFixed(1) + ' deg';
      document.getElementById('gamma').textContent = gamma.toFixed(1) + ' deg';
...
<body>
  ...
  <div class="media-demo">
    ...
    <div class="camera-controls">
      <button class="btn" onclick="startCamera()">[Play] Start Camera</button>
      <button class="btn" onclick="stopCamera()">[Stop] Stop Camera</button>
      <button class="btn" onclick="switchCamera()">[Switch] Switch Camera</button>
      <button class="btn record" onclick="takePhoto()">[Photo] Take Photo</button>
      <span class="recording-indicator" id="recordingIndicator">[REC] Recording</span>
    </div>
  ...
  <div class="media-demo">
    ...
    <div class="camera-controls">
      <button class="btn" onclick="startAudio()">[Play] Start Audio</button>
      <button class="btn" onclick="stopAudio()">[Stop] Stop Audio</button>
    </div>
...
Geolocation dan Device APIs memungkinkan aplikasi web untuk mengakses fitur hardware dan informasi lokasi yang sebelumnya hanya tersedia untuk native applications \cite{w3schools-html}. Dengan permission-based access dan privacy controls, APIs ini menyediakan fondasi untuk aplikasi web yang lebih personal dan interaktif \cite{mdn-api}.
