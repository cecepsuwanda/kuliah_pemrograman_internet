...
<body>
  <h1>[OK] HTML5 Validation & Best Practices</h1>
  
  <div class="validation-demo">
    <h2>[Note] Valid HTML5 Structure</h2>
    
    <div class="valid-example">
      <h4>[OK] Correct DOCTYPE and Basic Structure</h4>
...
&lt;/html&gt;
    ...
    <div class="valid-example">
      <h4>[OK] Proper Semantic Structure</h4>
      <div class="code-block">
&lt;header&gt;
  &lt;h1&gt;Website Title&lt;/h1&gt;
  &lt;nav&gt;
...
&lt;/footer&gt;
    ...
    <div class="valid-example">
      <h4>[OK] Accessible Images dengan Alt Text</h4>
      <div class="code-block">
...
&lt;!-- &lt;img src="important-chart.png"&gt; --&gt;
    ...
    <div class="valid-example">
      <h4>[OK] Proper Form Structure</h4>
      <div class="code-block">
...
&lt;/form&gt;
  ...
  <div class="validation-demo">
    ...
    <div class="invalid-example">
      <h4>[X] Missing Required Attributes</h4>
      <div class="code-block">
...
&lt;/p&gt;
    ...
    <div class="warning-example">
      <h4>[!] Deprecated Elements (Still valid but not recommended)</h4>
      <div class="code-block">
...
<body>
  ...
  <h1>[Accessibility] Accessible Web Design (WCAG 2.1)</h1>
  
  <!-- Principle 1: Perceivable -->
  <div class="accessibility-demo">
    <h2>[Eye] Principle 1: Perceivable</h2>
    
    <div class="wcag-principle">
      <h3>1.1 Text Alternatives (Level A)</h3>
      
      <div class="example-good">
        <h4>[OK] Good: Images dengan Descriptive Alt Text</h4>
      ...
      <div class="example-good">
        <h4>[OK] Good: Decorative Images dengan Empty Alt</h4>
      ...
      <div class="example-bad">
        <h4>[X] Bad: Missing atau Non-descriptive Alt Text</h4>
        <!-- Don't do this -->
    ...
    <div class="wcag-principle">
      ...
      <div class="example-good">
        <h4>[OK] Good: Sufficient Color Contrast</h4>
      ...
      <div class="example-bad">
        <h4>[X] Bad: Insufficient Color Contrast</h4>
      ...
      <div class="example-good">
        <h4>[OK] Good: High Contrast Mode Support</h4>
  ...
  <div class="accessibility-demo">
    <h2>[Keyboard] Principle 2: Operable</h2>
    
    <div class="wcag-principle">
      <h3>2.1 Keyboard Accessible (Level A)</h3>
      
      <div class="example-good">
        <h4>[OK] Good: Fully Keyboard Accessible Interface</h4>
      ...
      <div class="example-good">
        <h4>[OK] Good: Visible Focus Indicators</h4>
    ...
    <div class="wcag-principle">
      ...
      <div class="example-good">
        <h4>[OK] Good: Descriptive Page Title dan Headings</h4>
  ...
  <div class="accessibility-demo">
    <h2>[Brain] Principle 3: Understandable</h2>
    
    <div class="wcag-principle">
      <h3>3.1 Readable (Level AA)</h3>
      
      <div class="example-good">
        <h4>[OK] Good: Language Declaration</h4>
        <div class="aria-demo">
      ...
      <div class="example-good">
        <h4>[OK] Good: Unusual Words dan Abbreviations</h4>
        <p>
    ...
    <div class="wcag-principle">
      ...
      <div class="example-good">
        <h4>[OK] Good: Form Labels, Instructions, dan Error Prevention</h4>
  ...
  <!-- ARIA Attributes -->
  <div class="accessibility-demo">
    <h2>[ARIA] ARIA (Accessible Rich Internet Applications)</h2>
    
    <div class="wcag-principle">
      <h3>Common ARIA Attributes</h3>
      
      <div class="example-good">
        <h4>[OK] Good: ARIA untuk Dynamic Content</h4>
...
&lt;footer role="contentinfo"&gt;...&lt;/footer&gt;
  ...
  <!-- Testing Tools -->
  <div class="accessibility-demo">
    <h2>[Test] Accessibility Testing Tools</h2>
    ...
    <ul>
      <li>[OK] Navigate entire page menggunakan keyboard only (Tab, Shift+Tab, Enter, Space, Arrow keys)</li>
      <li>[OK] Test dengan screen reader (NVDA, VoiceOver, atau TalkBack)</li>
      <li>[OK] Periksa color contrast dengan tools seperti WebAIM Contrast Checker</li>
      <li>[OK] Zoom page ke 200% dan pastikan content masih readable</li>
      <li>[OK] Test dengan various assistive technologies</li>
      <li>[OK] Periksa semua images memiliki alt text yang appropriate</li>
      <li>[OK] Pastikan form labels terhubung dengan benar ke input fields</li>
    </ul>
    
    <button class="btn" onclick="window.open('https://wave.webaim.org/', '_blank')">
      [Search] Open WAVE Accessibility Tool
    </button>
  </div>
  
  <main id="main-content" class="accessibility-demo">
    <h2>[Checklist] WCAG 2.1 Compliance Checklist</h2>
    
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
      <div style="background-color: #d4edda; padding: 15px; border-radius: 8px;">
        <h3>Level A (Minimum)</h3>
        <ul>
          <li>[v] Text alternatives untuk images</li>
          <li>[v] Keyboard accessible</li>
          <li>[v] Captions/transcripts untuk multimedia</li>
          <li>[v] Color not sole method untuk conveying information</li>
          <li>[v] Form labels present</li>
        </ul>
      </div>
      ...
      <div style="background-color: #fff3cd; padding: 15px; border-radius: 8px;">
        ...
        <ul>
          <li>[v] Color contrast ratio minimum 4.5:1</li>
          <li>[v] Text resizing up to 200%</li>
          <li>[v] Consistent navigation</li>
          <li>[v] Error identification and suggestions</li>
          <li>[v] Accessible forms dengan error prevention</li>
        </ul>
      </div>
      ...
      <div style="background-color: #f8d7da; padding: 15px; border-radius: 8px;">
        ...
        <ul>
          <li>[v] Color contrast ratio 7:1</li>
          <li>[v] Sign language interpretation untuk video</li>
          <li>[v] Extended audio description</li>
          <li>[v] Reading level at lower secondary education</li>
          <li>[v] Context-sensitive help</li>
        </ul>
      </div>
    </div>
