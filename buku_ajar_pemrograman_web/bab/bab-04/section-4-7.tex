...
HTML5 memperkenalkan Web Workers untuk menjalankan JavaScript di background thread, memungkinkan aplikasi web yang responsif dan performant. Performance APIs menyediakan tools untuk mengukur dan mengoptimasi kinerja aplikasi \cite{mdn-api}. Kombinasi Web Workers dan Performance APIs membuka kemungkinan untuk aplikasi web yang kompleks tanpa blocking main thread \cite{w3schools-html}.
...
<body>
  ...
  <div class="perf-demo">
    ...
    <button class="btn" onclick="measureNavigationTiming()">[Stats] Measure Page Load</button>
    <button class="btn" onclick="clearLogs()">[X] Clear Logs</button>
  ...
  <div class="perf-demo">
    ...
    <button class="btn" onclick="startUserTiming()">[Play] Start Measurement</button>
    <button class="btn" onclick="markCheckpoint()">[Loc] Mark Checkpoint</button>
    <button class="btn" onclick="endUserTiming()">[Stop] End Measurement</button>
    <button class="btn" onclick="showUserTimings()">[Stats] Show Results</button>
  ...
  <div class="perf-demo">
    ...
    <button class="btn" onclick="checkMemory()">[Search] Check Memory</button>
    <button class="btn" onclick="createObjects()">[Box] Create Test Objects</button>
    <button class="btn" onclick="gcHint()">[X] Request GC</button>
  ...
  <div class="perf-demo">
    ...
    <button class="btn" onclick="startFrameMonitoring()">[Play] Start Monitoring</button>
    <button class="btn" onclick="stopFrameMonitoring()">[Stop] Stop Monitoring</button>
